...
import HeroMobileImage from "~/assets/images/hero-mobile.png?jsx";
import HeroDesktopImage from "~/assets/images/hero-desktop.png?jsx";
    ...
    <main class="flex min-h-screen flex-col p-6">
      ...
      <div class="mt-4 flex grow flex-col gap-4 md:flex-row">
        ...
        <div class="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          <HeroMobileImage class="lg:hidden" />
          <HeroDesktopImage class="hidden lg:block" />
        </div>
      </div>
    </main>
  );
